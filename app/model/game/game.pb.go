...
type GameConfig struct {
	...
	//游戏游戏logo地址
	Logo string `protobuf:"bytes,7,opt,name=logo,proto3" json:"logo,omitempty" xorm:"comment('游戏游戏logo地址') Varchar(255)"`
	//游戏地址
	Game string `protobuf:"bytes,8,opt,name=game,proto3" json:"game,omitempty" xorm:"comment('游戏地址') Varchar(255)"`
	//游戏版本
	Version              string   `protobuf:"bytes,9,opt,name=version,proto3" json:"version,omitempty" xorm:"comment('游戏版本') Varchar(255)"`
	XXX_NoUnkeyedLiteral struct{} `json:"-" xorm:"-" gorm:"-"`
	XXX_unrecognized     []byte   `json:"-" xorm:"-" gorm:"-"`
	XXX_sizecache        int32    `json:"-" xorm:"-" gorm:"-"`
}
...
var fileDescriptor_7512a9e7b9924428 = []byte{
	...
	,
}
...
func (m *GameConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Version) > 0 {
		...
		i = encodeVarintGame(dAtA, i, uint64(len(m.Version)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.Game) > 0 {
		i -= len(m.Game)
		copy(dAtA[i:], m.Game)
		i = encodeVarintGame(dAtA, i, uint64(len(m.Game)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Logo) > 0 {
		i -= len(m.Logo)
		copy(dAtA[i:], m.Logo)
		i = encodeVarintGame(dAtA, i, uint64(len(m.Logo)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Runmode) > 0 {
