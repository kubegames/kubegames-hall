...
import (
	...
	"github.com/kubegames/kubegames-hall/app/service/player/docs"
...
func main() {
	...
	server.HttpServer().GET("/player/swagger/*any", func(c *gin.Context) {
	...
	service.RegisterPlayerServiceHTTPServer(server.HttpServer(), player)

	//register grpc server
	service.RegisterPlayerServiceServer(server.GrpcServer(), player)
